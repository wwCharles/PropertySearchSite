        ...
        <div className="flex flex-col gap-4 flex-1 ">
          ...
          <div className="flex gap-4">
            ...
            <button
              ...
              className="p-2 bg-green-600 text-white border border-green-800 rounded uppercase hover:opacity-80 disabled:opacity-50"
            >
          ...
          <button
            ...
            className="p-2 bg-slate-800 text-white rounded uppercase hover:opacity-80 disabled:opacity-50"
          >
